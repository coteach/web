...
export const MockPlans = <Plan[]>[
    new Plan({
        ...
        userId: randUserId(),
        title: "搜尋演算法教案",
        starredNumber: randNumber(),
        forkedNumber: randNumber(),
  ...
  |教學設備|電腦教室、筆|`
    ...
    new Plan({
        ...
        starredNumber: randNumber(),
        forkedNumber: randNumber(),
        lastchangeAt: new Date('2020-03-08'),
        content:
            `# 名畫失竊記
...
export class MockData {
    static myId = MockMyId;
    static plans = MockPlans;
